...
本章的内容，讲解了基于Visual Studio Code来搭建ESP32-C3的开发环境，包括Espressif IDF插件的配置、固件的烧录、编译、程序的编辑以及SDK和工具包的更新，都可以在这里找到答案，也是开启ESP32-C3软件开发的第一站。
...
## 1.2.2.4 更新
当一些软件上的bug修复以及相应工具的升级，官方都会第一时间发布至Github上，所以我们应该时不时地更新一下自己本地的软件和相应的工具，以避免不必要的问题，具体的方式如下：
- SDK更新
